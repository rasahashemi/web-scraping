...
def scroll_down(driver, scroll_pause_time=3, scroll_limit=12):
...
def scrape_and_save_images(base_folder, num_images=100):
...
if __name__ == "__main__":
    base_folder = r"C:\Users\Lenovo\Desktop\image download"
    scrape_and_save_images(base_folder, num_images=100)